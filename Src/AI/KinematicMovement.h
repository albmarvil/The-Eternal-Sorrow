...
namespace AI 
{
	...
	*/
	...
	/**
	Movimiento Stop. 
	Disminuye la velocidad hasta pararse.
	*/
	class CKinematicStop : public IMovement
	{
	public:
		/**
		Constructor
		*/
		CKinematicStop(float maxLinearSpeed, float maxAngularSpeed, float maxLinearAccel, float maxAngularAccel) : 
			IMovement(maxLinearSpeed, maxAngularSpeed, maxLinearAccel, maxAngularAccel) { };
		/**
		Efectúa el movimiento.
