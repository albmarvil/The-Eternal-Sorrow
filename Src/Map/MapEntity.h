	...
	*/
	...
	public:
		...
		*/
		...
		std::vector<std::string> getVectorSTLAttribute(const std::string &attr) const;
		...
		*/
		...
		/*
		Añade los valores del arquetipo a la entidad. En casod e haber atributos identicos, prevalece el de la entidad.

		@param archetype CEntity que representa a un arquetipo.
		*/
		void mergeArchetype(CEntity *archetype);
		...
		*/
		...
		/**
		DEvuelve la lista de atributos de la entidad del mapa
		*/
		TAttrList *getAttributeList() {return &_attributes; }
