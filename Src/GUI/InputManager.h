...
namespace GUI
{
	...
	*/
	...
	public:
		...
		*/
		...
		{
			//BaseSubsystems::Log::Debug("pos x: " + std::to_string(posAbsX) + " - pos y: " + std::to_string(posAbsY));
	...
	*/
	...
	/*
	Namespace que contiene el tipo que define diferentes códigos de los botones del joystick
	*/
	namespace Joystick
	{
#ifndef _RIGHT_THRESHOLD
	#define _RIGHT_THRESHOLD 0.18
#endif
#ifndef _LEFT_THRESHOLD
	#define _LEFT_THRESHOLD 0.25
#endif
#ifndef _MAX_STICK
	#define _MAX_STICK SHRT_MAX
#endif

#ifndef _MIN_STICK
	#define _MIN_STICK SHRT_MIN
#endif

#ifndef _MAX_TRIGGER
	#define _MAX_TRIGGER 255
#endif
		
#ifndef _MAX_STICK_SPEED
	#define _MAX_STICK_SPEED 20
#endif	
		...
		enum XInputPOV
		{
			...
			XI_WEST = (1<<2),
			XI_EAST = (1<<3),
			XI_NORTHEAST = XI_NORTH | XI_EAST,
			XI_SOUTHEAST = XI_SOUTH | XI_EAST,
			XI_NORTHWEST = XI_NORTH | XI_WEST,
			XI_SOUTHWEST = XI_SOUTH | XI_WEST,
			XI_POV_ALL = XI_NORTH | XI_SOUTH | XI_WEST | XI_EAST
		};
	...
	public:
		...
		Joystick::XInputPOV _pov;

		Joystick::XInputButton _button;
	};
	...
	Esta clase debe ser implementada por las clases que quieren
	registrarse en el gestor de periféricos de entrada para ser
	avisados de eventos del joystick.
	Las funciones retornan cierto si el evento ha sido procesado.
	En este caso el gestor no llamará a otros listeners. Por 
	defecto los métodos devuelven false.
	...
	*/
	...
	public:
		...
		virtual bool povMoved(Joystick::POV pov) {return false;}

		virtual bool axisMoved(Joystick::Axis axis, float abs, float movement) {return false;}

		virtual bool buttonPressed(Joystick::Button button) { return false; }

		virtual bool buttonReleased(Joystick::Button button) { return false; }
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		Añade un oyente del joystick

		@param joystickListener Oyente del joystick
		*/
		...
		*/
		...
		/**
		Borra todos los oyentes del raton
		*/
		...
		*/
		...
		///Configura el flag de traducción del joystick como eventos del raton
		void setJoystickAsMouse(bool boolean) { _rightStickAsMouse = boolean; };

		bool getJoystickAsMouse() { return _rightStickAsMouse; };
	...
	private:
		...
		*/
		...
		@return false si se desea parar de procesar la entrada.
		*/
		...
		*/
		...
		Joystick::Button xinputButton2galeon(Joystick::XInputButton button);

		Joystick::POV xinputPOV2galeon(Joystick::XInputPOV pov);
		...
		bool axisMoved(Joystick::Axis axis, float abs, float mov);
		...
		void captureXinputPOV(unsigned short input);

		void captureXinputTriggers(unsigned char input, Joystick::Axis axis);

		void captureXinputButtons(unsigned short input);

		void captureXinputAxis(short input, Joystick::Axis axis);
		...
		*/
		...
		/*
		Buffer de la entrada de joystick de OIS
		*/
		...
		*/
		...
		/*
		Estado del joystick en el último evento
		*/
		CJoystickState _joystickState;
		
		//Falg que nos indica que estamos usando XInput
		bool _usingXInput;
		
		//Flag que nos indica que debemos traducir el stick derecho como si fuera el raton
		bool _rightStickAsMouse;
