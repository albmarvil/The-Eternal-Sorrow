	...
	*/
	...
	public:
		...
		*/
		...
		/**
		Crea en el gestor de mallas de Ogre una plano con las propiedades dadas.

		@param meshName Nombre de la malla
		@param normal Vector normal de la superficie del plano
		@param dist Distancia del plano sobre la normal
		@param width Ancho del plano construido
		@param heigth Alto del plano construido
		@param nTriangles Numero de triángulos verticales y horizontales del plano.
		*/
		void createPlaneMesh(const std::string &meshName, Vector3 normal, float dist, float width, float height, int nTriangles);

		/**
		Este método obtiene el rayo que se debe de lanzar desde la posición de la camara hasta la posición del cursor.
		@param screenx posición relativa en x del ratón en la pantalla
		@param screeny posición relativa en y del ratón en la pantalla
		@return Ray rayo que se debe lanzar
		*/
