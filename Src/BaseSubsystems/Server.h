	...
	*/
	...
	public:
		...
		*/
		...
		/**
		Devuelve la instancia de OIS del buffer del joystick
		...
		*/
		...
		OIS::Mouse *GetMouse() { return _mouse;}
	...
	protected:
		...
		*/
		...
		/*
		Inicialización y configuración inicial del sistema de LOG
