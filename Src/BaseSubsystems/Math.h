...
/**
Tipo Radian, usado para definir el ángulo en radianes de diferentes aspectos del motor, como por ejemplo
el FOVy de la camara. La definición del tipo de datos es la misma que la utilizada 
por el motor gráfico, por lo tanto es dependiente del motor usado.
 */
