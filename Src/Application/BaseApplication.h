...
namespace Application 
{
	...
	*/
	...
	public:
		...
		*/
		CApplicationState *getState() {return _statesActivates.back();}
		...
		***************************************************************/
		...
		el gestor no llamará a otros listeners.
		*/
		virtual bool povMoved(GUI::Joystick::POV pov);
		...
		el gestor no llamará a otros listeners.
		*/
		virtual bool axisMoved(GUI::Joystick::Axis axis, float abs, float movement);
		...
		el gestor no llamará a otros listeners.
		*/
		virtual bool buttonPressed(GUI::Joystick::Button button);
		...
		el gestor no llamará a otros listeners.
		*/
		virtual bool buttonReleased(GUI::Joystick::Button button);

		virtual void push(const std::string &nameState);
	...
	protected:
		...
		*/
		...
		//Pila de estados activos
		std::vector<CApplicationState*> _statesActivates;
