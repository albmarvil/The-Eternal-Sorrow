...
#ifndef __Application_OptionControlState_H
#define __Application_OptionControlState_H
...
namespace Application 
{
	...
	class COptionControlState : public CApplicationState 
	{
	public:
		/** 
		Constructor de la clase 
		*/
		COptionControlState(CBaseApplication *app);

		/** 
		Destructor 
		*/
		virtual ~COptionControlState();
