	...
	*/
	...
	public:
		...
		***************************************************************/
		...
		el gestor no llamará a otros listeners.
		*/
		virtual bool povMoved(GUI::Joystick::POV pov) { return false; }
		...
		el gestor no llamará a otros listeners.
		*/
		virtual bool axisMoved(GUI::Joystick::Axis axis, float abs, float movement){ return false; }
		...
		el gestor no llamará a otros listeners.
		*/
		virtual bool buttonPressed(GUI::Joystick::Button button){ return false; }
		...
		el gestor no llamará a otros listeners.
		*/
		virtual bool buttonReleased(GUI::Joystick::Button button){ return false; }
