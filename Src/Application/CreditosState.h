...
#ifndef __Application_CreditosState_H
#define __Application_CreditosState_H
...
namespace Application 
{
	...
	class CCreditosState : public CApplicationState 
	{
	public:
		/** 
		Constructor de la clase 
		*/
		CCreditosState(CBaseApplication *app);

		virtual ~CCreditosState(){}
		/**
...
#endif //  __Application_CCreditosState_H
