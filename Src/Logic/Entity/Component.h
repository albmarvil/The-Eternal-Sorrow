...
*/
	...
	public:
		...
		*/
		IComponent() : _entity(0), _isActive(true) {}
		...
		*/
		virtual bool spawn(CEntity* entity, const Map::CEntity *entityInfo);

		virtual bool OnSpawn(const Map::CEntity *entityInfo){ return true;}
		...
		**/
		virtual bool respawn(const Map::CEntity *entity){ return true;}
		...
		*/
		virtual bool onSleep(){return true;}

	

		/**
		Método que establece el nombre del componente.
		...
		*/
		...
		/**
		Método que devuelve el nombre del componente.

		@return El nombre del componente
		*/
		std::string getName() { return _name; }

		virtual bool getSleeping(){ return _isSleeping;}

		virtual void setSleeping(bool _dormido);

		/**
		Comprueba si un componente está activo o no
		*/
