...
namespace Logic 
{
	...
	/*
	Esta clase es la que implementarán los componentes que quieran ser notificados de los cambios de posicion
	de la entidad. Usaremos el patron observer para sustituir de forma progresiva la propagación del mensaje
	SET_TRANSFORM
	*/
	...
	*/
	...
	public:
		...
		**/
		...
		/*
		Método consultor para el tag de la entidad
		...
		*/
		...
		/*
		Método consultor para el activate de la entidad
	...
	protected:
		...
		**/
		...
		/*
		Tag de la entidad. Indica al grupo lógico al que pertenece
		*/
		std::string _tag;

		//Lista de observadores de la posición lógica de la entidad
