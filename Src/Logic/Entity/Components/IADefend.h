#ifndef __Logic_IADefend_H
#define __Logic_IADefend_H

#include "Logic/Entity/Component.h"

namespace Logic 
{
	class CIADefend : public IComponent
	{
		DEC_FACTORY(CIADefend);

	public:

		CIADefend() : IComponent() {}
	...
	protected:
		...
		int _rangeDefend;
		int _maxTimeDefend;
		int _currentTimeDefend;
		int _successPercent;

	}; // class Controller

	REG_FACTORY(CIADefend);
