#ifndef __Logic_IASeekRay_H
#define __Logic_IASeekRay_H
...
namespace Logic 
{
	...
	class CIASeekRay : public IComponent
	{
		DEC_FACTORY(CIASeekRay);

	public:

		CIASeekRay() : IComponent() {}
