...
#ifndef __Logic_Puntual_H
#define __Logic_Puntual_H
...
{
/**
	Este componente controla la luz puntual. La entidad que tenga este componente asociado, tendrá asociado
	una luz. Desde el fichero Map.txt puede ser configurada en las diferentes luces de ogre:
*/
	class CPuntualLight : public IComponent, public CEntityTransformListener
	{
		DEC_FACTORY(CPuntualLight);
	public:

		/**
		Constructor por defecto; en la clase base no hace nada.
		*/
		CPuntualLight() : IComponent(){}
		
		virtual ~CPuntualLight();
		/**
	...
	protected:
		...
		*/
		...
		/*Parámetros para configurar la atenuación de la luz puntual */
