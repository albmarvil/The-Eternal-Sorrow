#ifndef __Logic_IARunAway_H
#define __Logic_IARunAway_H

#include "Logic/Entity/Component.h"

namespace Logic 
{
	class CIARunAway : public IComponent
	{
		DEC_FACTORY(CIARunAway);

	public:

		CIARunAway() : IComponent() {}
