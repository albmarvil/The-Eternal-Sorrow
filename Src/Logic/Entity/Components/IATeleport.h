#ifndef __Logic_IATeleport_H
#define __Logic_IATeleport_H

#include "Logic/Entity/Component.h"

namespace Logic 
{
	class CIATeleport : public IComponent
	{
		DEC_FACTORY(CIATeleport);

	public:

		CIATeleport() : IComponent() {}
	...
	protected:
		...
		CEntity* _target;
		int _maxDelayTeleporting;
		int _currentDelayTeleporting;
		int _stepIA;
		bool _canBeHit;
		int _rangeDetect;
		bool _initIA;
		int _successPercent;
		bool _hasBeenAttacked;
		int _maxCooldownTeleport;
		int _currentCooldownTeleport;

	}; // class Controller

	REG_FACTORY(CIATeleport);
