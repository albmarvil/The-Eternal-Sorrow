#ifndef __Logic_IAShootRaycast_H
#define __Logic_IAShootRaycast_H

#include "Logic/Entity/Component.h"

namespace Logic 
{
	class CIAShootRaycast : public IComponent
	{
		DEC_FACTORY(CIAShootRaycast);

	public:

		CIAShootRaycast() : IComponent(), _delayShoot(0) {}

		virtual ~CIAShootRaycast();
