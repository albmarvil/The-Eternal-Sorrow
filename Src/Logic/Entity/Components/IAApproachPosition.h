#ifndef __Logic_IAApproachPosition_H
#define __Logic_IAApproachPosition_H

#include "Logic/Entity/Component.h"

namespace Logic 
{
	class CIAApproachPosition : public IComponent
	{
		DEC_FACTORY(CIAApproachPosition);

	public:

		CIAApproachPosition() : IComponent() {}

		virtual ~CIAApproachPosition();
	...
	REG_FACTORY(CIAApproachPosition);
