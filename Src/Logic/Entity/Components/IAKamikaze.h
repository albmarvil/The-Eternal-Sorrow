#ifndef __Logic_IAKamikaze_H
#define __Logic_IAKamikaze_H

#include "Logic/Entity/Component.h"

namespace Logic 
{
	class CIAKamikaze : public IComponent
	{
		DEC_FACTORY(CIAKamikaze);

	public:

		CIAKamikaze() : IComponent() {}
