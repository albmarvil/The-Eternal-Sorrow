...
--#################################################################################################################################################
	...
	TriggerPuertaVerticalDerecha = {
		...
		sourceParticles = {"LlamaCalaverasAzul"},
...
--#################################################################################################################################################
	...
	TILE_FRAGILE = {
		type = "TILE_FRAGILE",
		model = "Tile.mesh",  --"Tile.mesh",
		material = "Tiles/Nieve/FragilRotura1",
		orientation = {1, 0, 0},
		...
		numTouchsToBreak = 3,
		matBreak1 = "Tiles/Nieve/FragilRotura1",
		matBreak2 = "Tiles/Nieve/FragilRotura2",
		matBreak3 = "Tiles/Nieve/FragilRotura3",
	...
	TILE_FRAGILE_BORDE = {
		...
		model = "Tile.mesh",  --"Tile.mesh",
		material = "Tiles/Nieve/FragilRotura1Borde",
		orientation = {1, 0, 0},
		orientation_angle = 180, --90, para el marine -- -90 para sai02
		scale = {1, 1, 1},
		static = true,
		...
		-- Atributo para CTileFragile--
		numTouchsToBreak = 3,
		matBreak1 = "Tiles/Nieve/FragilRotura1Borde", 
		matBreak2 = "Tiles/Nieve/FragilRotura2Borde",
		matBreak3 = "Tiles/Nieve/FragilRotura3Borde",
	},
	...
	TileCapa1Borde = {
		...
		model = "Tile.mesh",  --"Tile.mesh",
		material = "Tiles/Nieve/FrontalBorde",
		scale = {1, 1, 1},
		static = true,
		physic_entity = "rigid",
		physic_type = "static",
	...
	TileSlide1Borde = {
		...
		model = "TileSlide01.mesh",      --"TileSlide0160.mesh",	---"TileSlide01.mesh",
		-- material = "Tiles/Nieve/OblicuoBorde01",
		material = "Tiles/Nieve/FrontalBorde",
		scale = {1, 1, 1},
		static = true,
		physic_entity = "fromFile",
	...
	TileSlide2Borde = {
		...
		model = "TileSlide02.mesh", 
		-- material = "Tiles/Nieve/OblicuoBorde02",
		material = "Tiles/Nieve/FrontalBorde",
		scale = {1, 1, 1},
		static = true,
		physic_entity = "fromFile",
	...
	TileSlide5Borde = {
		...
		model = "TileSemiSlide01.mesh",            --"TileSemiSlide0160.mesh",	---"TileSemiSlide01.mesh",
		-- material = "Tiles/Nieve/OblicuoBordeB01",
		material = "Tiles/Nieve/FrontalBorde",
		scale = {1, 1, 1},
		static = true,
		physic_entity = "fromFile",
	...
	TileSlide6Borde = {
		...
		model = "TileBigSemiSlide01.mesh",        --"TileSemiSlide0260.mesh",	---"TileSemiSlide02.mesh",
		-- material = "Tiles/Nieve/OblicuoBordeA01",
		material = "Tiles/Nieve/FrontalBorde",
		scale = {1, 1, 1},
		static = true,
		physic_entity = "fromFile",
	...
	TileSlide7Borde = {
		...
		model = "TileBigSemiSlide02.mesh",
		-- material = "Tiles/Nieve/OblicuoBordeA02",
		material = "Tiles/Nieve/FrontalBorde",
		scale = {1, 1, 1},
		static = true,
		physic_entity = "fromFile",
	...
	TileSlide8Borde = {
		...
		model = "TileSemiSlide02.mesh",
		-- material = "Tiles/Nieve/OblicuoBordeB02",
		material = "Tiles/Nieve/FrontalBorde",
		scale = {1, 1, 1},
		static = true,
		physic_entity = "fromFile",
