...
EnemApprDodgeContenedor = { 
	...
	CrecimientoDinero = function (level)
		...
		min = 2 * level + EnemApprDodgeContenedor.rangoDineroBase.min
		max = 2 * level + EnemApprDodgeContenedor.rangoDineroBase.max
...
Drop.Contenedores[EnemApprDodge.Archetype] = EnemApprDodgeContenedor

-------------------------APUNTADO EN LA TABLA-----------------------

if SpawnerMgr.tiers["Tier"..EnemApprDodge.tier] == nil then
	SpawnerMgr.tiers["Tier"..EnemApprDodge.tier] = {Enemigos = {},}
end

table.insert(SpawnerMgr.tiers["Tier"..EnemApprDodge.tier].Enemigos, EnemApprDodge)