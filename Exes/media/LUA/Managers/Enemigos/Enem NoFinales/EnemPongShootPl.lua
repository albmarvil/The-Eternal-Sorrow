...
-------------------------------TABLA EnemPongShootPl---------------------------
EnemPongShootPl = {
	--variables del enemigo
	id = 1,
	tier = 2,
	Archetype = "EnemPongShootPl",
	...
	GetNextID = function (  )
		local id = EnemPongShootPl.id + 1
		EnemPongShootPl.id = id
		return id
	end,
}
...
EnemPongShootPlContenedor = { 
	...
	CrecimientoDinero = function (level)
		...
		min = 2 * level + EnemPongShootPlContenedor.rangoDineroBase.min
		max = 2 * level + EnemPongShootPlContenedor.rangoDineroBase.max
...
Drop.Contenedores[EnemPongShootPl.Archetype] = EnemPongShootPlContenedor

-------------------------APUNTADO EN LA TABLA-----------------------

if SpawnerMgr.tiers["Tier"..EnemPongShootPl.tier] == nil then
	SpawnerMgr.tiers["Tier"..EnemPongShootPl.tier] = {Enemigos = {},}
end

table.insert(SpawnerMgr.tiers["Tier"..EnemPongShootPl.tier].Enemigos, EnemPongShootPl)