...
MewtwoContenedor = { 
	...
	CrecimientoDinero = function (level)
		...
		min = 2 * level + MewtwoContenedor.rangoDineroBase.min
		max = 2 * level + MewtwoContenedor.rangoDineroBase.max
...
Drop.Contenedores[Mewtwo.Archetype] = MewtwoContenedor

-------------------------APUNTADO EN LA TABLA-----------------------

if SpawnerMgr.tiers["Tier"..Mewtwo.tier] == nil then
	SpawnerMgr.tiers["Tier"..Mewtwo.tier] = {Enemigos = {},}
end

table.insert(SpawnerMgr.tiers["Tier"..Mewtwo.tier].Enemigos, Mewtwo)