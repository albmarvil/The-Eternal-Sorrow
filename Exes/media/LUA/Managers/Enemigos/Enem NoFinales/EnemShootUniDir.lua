...
EnemShootUniContenedor = { 
	...
	CrecimientoDinero = function (level)
		...
		min = 2 * level + EnemShootUniContenedor.rangoDineroBase.min
		max = 2 * level + EnemShootUniContenedor.rangoDineroBase.max
...
Drop.Contenedores[EnemShootUni.Archetype] = EnemShootUniContenedor

-------------------------APUNTADO EN LA TABLA-----------------------

if SpawnerMgr.tiers["Tier"..EnemShootUni.tier] == nil then
	SpawnerMgr.tiers["Tier"..EnemShootUni.tier] = {Enemigos = {},}
end

table.insert(SpawnerMgr.tiers["Tier"..EnemShootUni.tier].Enemigos, EnemShootUni)