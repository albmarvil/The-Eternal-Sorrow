...
-------------------------------TABLA MinionSummonKami---------------------------
MinionSummonKami = {
	--variables del enemigo

	id = 1,
	tier = 1,
	Archetype = "MinionSummonKami",
	...
	GetNextID = function (  )
		local id = MinionSummonKami.id + 1
		MinionSummonKami.id = id
		return id
	end,
}
...
MinionSummonKamiContenedor = { 
	...
	CrecimientoDinero = function (level)
		...
		min = 2 * level + MinionSummonKamiContenedor.rangoDineroBase.min
		max = 2 * level + MinionSummonKamiContenedor.rangoDineroBase.max
...
Drop.Contenedores[MinionSummonKami.Archetype] = MinionSummonKamiContenedor

-------------------------APUNTADO EN LA TABLA-----------------------

if SpawnerMgr.tiers["Tier"..MinionSummonKami.tier] == nil then
	SpawnerMgr.tiers["Tier"..MinionSummonKami.tier] = {Enemigos = {},}
end

table.insert(SpawnerMgr.tiers["Tier"..MinionSummonKami.tier].Enemigos, MinionSummonKami)